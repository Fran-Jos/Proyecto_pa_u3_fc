...
public class EstudianteRepoImpl implements IEstudianteRepo {
	...
	public int eliminarPorApellido(String apellido) {
		...
		//DELETE FROM estudiante WHERE estu_apellido='Quisilema'
	...
	public int actualizarPorApellido(String apellido,String nombre) {
		// TODO Auto-generated method stub
		//UPDATE estudiante set estu_nombre='Anddy' WHERE estu_apellido='Quisilema".
	...
	public int actualizarPorNombre(String nombre, String apellido) {
		// TODO Auto-generated method stub
		Query query= this.entityManager.createQuery("UPDATE Estudiante e SET e.apellido=:datoApellido WHERE e.nombre=:datoNombre");
	...
	public int eliminarPorCiudad(String ciudad) {
		// TODO Auto-generated method stub
		Query query=this.entityManager.createQuery("DELETE FROM Estudiante e WHERE e.ciudad= :datoCiudad");
	...
	public int actualizarPorCiudad(String ciudad, String nombre) {
		// TODO Auto-generated method stub
		Query query= this.entityManager.createQuery("UPDATE Estudiante e SET e.nombre=:datoNombre WHERE e.ciudad=:datoCiudad");
		
		query.setParameter("datoNombre", nombre);
		query.setParameter("datoApellido", ciudad);
		return query.executeUpdate();
	}
