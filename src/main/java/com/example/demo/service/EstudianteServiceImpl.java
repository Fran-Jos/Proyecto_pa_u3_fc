...
public class EstudianteServiceImpl implements IEstudianteService {
	...
	public int actualizarPorNombre(String nombre, String apellido) {
		// TODO Auto-generated method stub
		return this.estudianteRepo.actualizarPorNombre(nombre, apellido);
	}

	@Override
	public int eliminarPorCiudad(String ciudad) {
		// TODO Auto-generated method stub
		return this.estudianteRepo.eliminarPorCiudad(ciudad);
	}

	@Override
	public int actualizarPorCiudad(String ciudad, String nombre) {
		// TODO Auto-generated method stub
		return this.estudianteRepo.actualizarPorCiudad(ciudad, nombre);
	}
